...
namespace Chess
{
    internal class Coordinates
    {
        ...
        public char PieceX { get; set; }
        public char PieceY { get; set; }
        public char TargetX { get; set; }
        public char TargetY { get; set; }
        public char MoveX { get; set; }
        public char MoveY { get; set; }
        ...
        internal static Coordinates CoordinatesRandom()
        {
            ...
            while (true)
            {
                ...
                } while (!pieces.Contains(coordinates.FirstPiece) || string.IsNullOrWhiteSpace(coordinates.FirstPiece));
